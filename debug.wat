(component
  (core module (;0;)
    ...
    (func $hello-world (;1;) (type 1) (result i32)
    ...
    (func $_ZN11wit_bindgen2rt14run_ctors_once17h75299ea2082767b2E (;4;) (type 0)
      block ;; label = @1
        i32.const 0
  ...
  (alias core export 0 "hello-world" (core func (;1;)))
  (func (;0;) (type 0) (canon lift (core func 1)))
  (export (;1;) "hello-world" (func 0))
  (@producers
    (processed-by "wit-component" "0.19.1")
    (processed-by "cargo-component" "0.6.0 (wasi:6613acd)")
  )
)